        ...
        >
          ...
          >
            <div className="d-flex flex-column justify-content-center align-items-center text-center">
              ...
              <h1 className="font-1 fw-bold white-color">
          ...
          <div className="r-container">
            <div className="skills__wrapper">
              ...
              <label className="font-1 fw-bold m-0 lh-1 white-color">
                Design and Development Skill
              </label>
              <div className="divider m-0 accent-color me-auto">
                <i className="fa-solid fa-square-full"></i>
              </div>
              <p className="white-color">
                In the realm of digital craftsmanship, I bring a fusion of
                creativity and technical prowess. With a passion for innovative
                design, I specialize in creating visually captivating user
                experiences. From concept to deployment, my development skills
                ensure seamless functionality and responsiveness. Whether it's
                crafting intuitive interfaces or building robust back-end
                systems, I am committed to delivering solutions that elevate
                your digital presence. Explore my portfolio and witness the
                convergence of design and development expertise in every
                project.
              </p>
